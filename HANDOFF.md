...
- ✅ **モック UI スキャフォールド**: [DESIGN.md](DESIGN.md)、[screen-design.md](docs/web-app/screen-design.md)（§2 ポータル IA をモックで反映）、[mock-ui-boundary.md](docs/web-app/mock-ui-boundary.md)、`src/eb_app/`（`portal_frame.py`・`EB_ENABLE_MOCK_UI=1`）
...
- `docs/web-app/screen-design.md` — 画面設計書（本番 URL・モック・SCR ID）
