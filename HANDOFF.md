...
- **Phase 0 で新規作成済み**: `docs/phase0/`、`docs/pjc/*.md`、`docs/wbs/*.md`
- **これから新規作成**: `docs/requirements/v0.4+.md`、（任意）PJC/WBS の Google シート反映、`src/` 配下の FastAPI コード等
